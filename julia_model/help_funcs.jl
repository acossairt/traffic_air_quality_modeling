...
function build_symbolic_model_diurnal_NEW(; make_prob=true, make_plot=true, Np=2, Nc=1,
...
function build_symbolic_model_diurnal(; make_prob=true, make_plot=true, Np=2, Nc=1, my_kp, my_kc, my_u=1, my_v=0, my_α, my_kc_jam, my_period, γ_version="default", t_end=120, v_f=90, my_L=0.6, my_k=10, my_x0=0.8, my_shift=0, x_pos=0.8, y_pos=0.8)
    #=
...
function calc_space_mean_speed_alternative(v_f, C, my_kc_jam; a=0.5, Np=2, Nc=2)
    #=
        Returns:
            - u_s: float
