...
# Set initial conditions - 90% of pop in patch 1, 10% in corridor p1 → p2
# Result - way too high. But hard to see what happens if zoom in
kp_init = [0.9; 0.0]
...
prefix = "study_turn_off_entry"
suffix = "entry_off"
savefig(plt, "studies/graphics/$prefix" * "_traffic_pop_curve_diurnal_test_" * demand_function * "_Nc_$Nc" * "_kc_half_jam_denom_$kc_half_jam_denominator" * "_L_$my_L" * "_r_$my_r" * "_x0_$my_x0" * "_shift_$my_shift" * "_$suffix" * ".png")
